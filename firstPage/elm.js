...
var $author$project$PortExamples$sendDataToJS = _Platform_outgoingPort('sendDataToJS', $elm$json$Json$Encode$string);
var $author$project$PortExamples$update = F2(
	function (msg, model) {
		if (msg.$ === 'SendDataToJS') {
			return _Utils_Tuple2(
				model,
				$author$project$PortExamples$sendDataToJS('Hello JavaScript'));
		} else {
			var data = msg.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text('Data received from JS: ' + model)
			]));
};
